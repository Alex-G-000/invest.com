...
<section class="slider-category">
	<div class="container">
		<h6 class="slider-category__title text-dark--light">
		  CATEGORIES
		</h6>
		<div class="slider-category__wrapper">			
			<div class="slider-category__slider swiper">			
				...
				{	
				?>
					<a class="slider-category__item swiper-slide bg-dark-1" href="<?php echo get_category_link( $category->cat_ID ); ?>">
						<span class="slider-category__item-text text-black--light">			
			...
			<div class="slider-category__nav slider-category__next bg-dark-1">
				<span>
