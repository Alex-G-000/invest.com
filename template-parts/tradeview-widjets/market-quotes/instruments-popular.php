...
<div class="tradingview-widget-container">
		...
		async>
	{
		...
		"symbolsGroups": [{
			...
			"symbols": [
				<?php  
                if( have_rows('instruments_instruments-popular-widget', 'options') ):
                $count_rows = count(get_field('instruments_instruments-popular-widget', 'options'));
                $current = 0;  
                while( have_rows('instruments_instruments-popular-widget', 'options') ): the_row();    
