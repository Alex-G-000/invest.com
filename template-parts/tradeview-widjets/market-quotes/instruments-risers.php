...
<div class="tradingview-widget-container">
		...
		async>
	{
		...
		"symbolsGroups": [{
			...
			"symbols": [
				<?php  
                if( have_rows('instruments-risers-widget', 'options') ):
                $count_rows = count(get_field('instruments-risers-widget', 'options'));
                $current = 0;  
                while( have_rows('instruments-risers-widget', 'options') ): the_row();    
