...
<section class="first-screen hero bg-dark mb-0">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 hero__content-col">
				...
				<div data-aos="fade-right" data-aos-duration="1200">
					...
					<h3 class="hero__subtitle text-gray--dark  text-white--light">

						<?php echo $subtitle; ?>

					</h3>

					<a href="<?php inv_show_download_link(); ?>"
				...
				<div class="hero__app-links app-links">
					...
					<div class="app-links__col">
						...
						<a href="<?php the_field('app-links_apple-download-link', 'options'); ?>"
							class="app-links__button btn-app -store mb-md-2 mr-2 mr-md-0"></a>
					...
					<div class="app-links__devider d-none d-md-flex"></div>

					<div class="app-links__col d-none d-md-flex">
				...
				<a href="<?php echo $small_link_url; ?>"
					class="hero__link text-white"><?php echo $small_link_text; ?></a>
